...
def calculate(df_recipe, df_inventory, df_score):
  ...
  #print(allProductUsage)
  
  #2.2.2 Total Supply
  allIngredientSupply = np.array(df_inventory['Ai'])
  # print(allIngredientSupply)
  ...
  # product_array = []
  # for i in range(len(df_score.index)):
  #   product_array_add = df_score.iloc[i, 0]
  #   product_array.append(product_array_add)

  #  = np.stack((product_array, res['x']), axis=1)
  return res['x']
